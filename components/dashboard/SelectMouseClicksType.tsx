...
import type { VizTypeFilter } from '../../@types'
  ...
  return (
    <Listbox value={picked} onChange={setPicked}>
      <div className="relative z-50 w-full min-w-full md:w-auto md:min-w-[10rem]">
        <Listbox.Button
          as="button"
          className="inline-flex w-full items-center justify-center gap-x-1 rounded border border-primary bg-primary/80 py-2 pl-3 pr-2 text-center text-sm font-medium tracking-tight text-white transition hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-50 dark:border-secondary dark:bg-secondary/50 lg:px-2 lg:py-1.5"
        >
