...
export default function Sidebar({ location }: Props) {
  ...
  return (
    <aside className="flex h-screen min-w-[20rem] flex-col space-y-4 bg-white p-5 dark:bg-darkest">
      <div className="flex items-center justify-start gap-2 px-2">
        {/* <Image src="/logo.svg" alt="CMF MES" width={256} height={256} className="h-8 w-8" /> */}
        <span className="h-8 w-8 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 dark:from-orange-500 dark:to-orange-700" />
            ...
            <li key={`nav-${itemIdx}`}>
              <Link
                ...
                className={classNames(
                  isActive
                    ? 'bg-slate-800 text-white dark:bg-orange-500'
                    : 'hover:bg-slate-200 dark:hover:bg-orange-500',
